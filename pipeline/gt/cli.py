...
def layer_run(
    ...
    layer_runners = {
        ...
        "median_home_value": run_median_home_value,
        "noise_mean_dba": run_noise,
        "noise_pct_over_45": run_noise,
        "noise_pct_over_55": run_noise,
        "noise_siren_density": run_noise_sources,
        "noise_siren_distance_m": run_noise_sources,
        "noise_nightlife_density": run_noise_sources,
        "noise_nightlife_count_300m": run_noise_sources,
        "noise_industrial_land_pct": run_noise_sources,
        "noise_industrial_distance_m": run_noise_sources,
        "noise_freight_rail_density": run_noise_sources,
        "noise_freight_rail_distance_m": run_noise_sources,
        "park_access": run_park_access,
